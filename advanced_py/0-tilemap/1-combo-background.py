...
background = pygame.image.load("./advanced_py/0-tilemap/background.png").convert()
dirt = pygame.image.load("./advanced_py/0-tilemap/dirt.png").convert_alpha()
grass = pygame.image.load("./advanced_py/0-tilemap/grass.png").convert_alpha()
...
# 每个数字代表一种瓦片：0 = dirt, 1 = grass, 2 = water
# 每行代表一排瓦片，每列就是横向排列
tilemap = [
    [0, 0, 1, 1, 1, 2, 2, 2, 1, 0],
    [0, 1, 1, 2, 2, 2, 1, 1, 1, 0],
