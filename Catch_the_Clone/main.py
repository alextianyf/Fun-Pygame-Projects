...
#Set sound and music
click_sound = pygame.mixer.Sound("Catch_the_Clone/click_sound.wav")
miss_sound = pygame.mixer.Sound("Catch_the_Clone/miss_sound.wav")
pygame.mixer.music.load("Catch_the_Clone/ctc_background_music.wav")

#Set images
background_image = pygame.image.load("Catch_the_Clone/background.png")
